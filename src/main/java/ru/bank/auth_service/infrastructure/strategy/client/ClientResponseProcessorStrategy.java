...
public interface ClientResponseProcessorStrategy {
    LoginResponseDto processorLoginResponse(Users user, String accessToken, String refreshToken, HttpServletResponse response);
